...
- [CNBE Data Reproducibility Contract](./docs/DATA_REPRODUCIBILITY_CONTRACT.md)
- [CNBE Version Governance](./docs/CNBE_VERSION_GOVERNANCE.md)
- [Repository Structure](./docs/REPOSITORY_STRUCTURE.md)
- [CNBE Structure Type Runtime Spec](./spec/struct_types.json)
- [Top-level Agent Directory](./agents/README.md)

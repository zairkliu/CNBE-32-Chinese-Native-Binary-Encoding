...
- 8105 人审结构基线已完成（8105/8105）；运行时库现有 8105/8105 行，其中标准轨
  7602 行、legacy 轨 503 行；503 行补录候选包见
  `evidence/8105/8105_REMAINING_503_COMPLETION_PACKET.json`，未获治理批准前不写入发布库；

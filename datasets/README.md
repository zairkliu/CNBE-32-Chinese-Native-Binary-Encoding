...
- 8105 人审结构基线已完成（8105/8105）；运行时库现有 21,184 行，其中标准轨
  7,602 行、provisional 812 行（2026-08-06 人工全量审核后提升）、legacy 轨
  12,770 行；提升记录见
  `experiments/2026-08-06_variant_normalization/runtime_promotion_2026-08-06.json`；

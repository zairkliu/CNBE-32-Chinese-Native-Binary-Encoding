...
TEXT_FILES = [
    ...
    "tests/test_doc_version.py",
    "tests/test_struct_types_spec.py",
    "spec/golden_vectors.json",
    "spec/struct_types.json",
    ...
    "scripts/validate_doc_version.py",
    ...
    "scripts/verify_cnbe_agent_runtime_logic.py",
    ...
    "scripts/evaluate_full_catalog_gf0017_batch_readiness.py",
    ...
    "reports/WORKFLOW_STAGE_SUMMARY_EVALUATION.md",
    "reports/FULL_CATALOG_PRE_GF0017_HANDOFF.md",
    "reports/cnbe_agent_runtime_logic_verification.json",
    "reports/CNBE_AGENT_RUNTIME_LOGIC_VERIFICATION.md",
    "agents/README.md",
    ...
    "reports/full_catalog_gf0017_preflight_plan.json",
    ...
    "reports/structured_8105_knowledge_patch_report.json",
    "reports/STRUCTURED_8105_KNOWLEDGE_PATCH_REPORT.md",
    "reports/full_catalog_gf0017_batch_readiness.json",
    "reports/FULL_CATALOG_GF0017_BATCH_READINESS.md",
    ...
    "reports/full_catalog_evidence_review_plan.json",
    "reports/FULL_CATALOG_EVIDENCE_REVIEW_PLAN.md",
    "docs/CNBE32_GF0017_AGENT_TECHNICAL_WHITEPAPER.md",
...
MIN_LINES = {
    ...
    "tests/test_doc_version.py": 40,
    "tests/test_struct_types_spec.py": 60,
    "spec/golden_vectors.json": 150,
    "spec/struct_types.json": 60,
    ...
    "scripts/validate_doc_version.py": 100,
    ...
    "scripts/verify_cnbe_agent_runtime_logic.py": 250,
    "scripts/plan_full_catalog_gf0017_preflight.py": 350,
    "scripts/map_full_catalog_gf0017_sources.py": 350,
    "scripts/design_full_catalog_gf0017_join_schema.py": 350,
    "scripts/reconcile_full_catalog_gf0017_blockers.py": 200,
    "scripts/diff_structured_8105_knowledge.py": 250,
    "scripts/patch_structured_8105_knowledge.py": 250,
    "scripts/evaluate_full_catalog_gf0017_batch_readiness.py": 200,
    "scripts/run_full_catalog_gf0017_source_join_batch.py": 220,
    ...
    "scripts/inspect_full_catalog_excel_schemas.py": 250,
    "scripts/inspect_v4_fixed_sample_rows.py": 220,
    "scripts/audit_v4_fixed_unicode_identity.py": 220,
    "reports/full_catalog_excel_schema_comparison.json": 250,
    "reports/full_catalog_v4_fixed_sample_rows.json": 300,
    "reports/full_catalog_v4_fixed_unicode_identity.json": 1000,
    "reports/WORKFLOW_STAGE_SUMMARY_EVALUATION.md": 150,
    "reports/FULL_CATALOG_PRE_GF0017_HANDOFF.md": 180,
    "reports/cnbe_agent_runtime_logic_verification.json": 80,
    "reports/CNBE_AGENT_RUNTIME_LOGIC_VERIFICATION.md": 40,
    "agents/README.md": 80,
    "agents/skills/README.md": 45,
    "agents/manifests/README.md": 55,
    "agents/manifests/cnbe-hanzi-structure-encoding-agent.invocation.json": 80,
    "agents/templates/README.md": 35,
    "agents/templates/cnbe-agent-run-report.md": 55,
    "reports/full_catalog_gf0017_preflight_plan.json": 180,
    "reports/FULL_CATALOG_GF0017_PREFLIGHT_PLAN.md": 70,
    "reports/full_catalog_gf0017_source_mapping.json": 250,
    "reports/FULL_CATALOG_GF0017_SOURCE_MAPPING.md": 60,
    "reports/full_catalog_gf0017_join_schema.json": 200,
    "reports/FULL_CATALOG_GF0017_JOIN_SCHEMA.md": 60,
    "reports/full_catalog_gf0017_blocker_reconciliation.json": 60,
    "reports/FULL_CATALOG_GF0017_BLOCKER_RECONCILIATION.md": 50,
    "reports/structured_8105_knowledge_diff_packet.json": 90,
    "reports/STRUCTURED_8105_KNOWLEDGE_DIFF_PACKET.md": 60,
    "reports/structured_8105_knowledge_patch_report.json": 50,
    "reports/STRUCTURED_8105_KNOWLEDGE_PATCH_REPORT.md": 35,
    "reports/full_catalog_gf0017_batch_readiness.json": 300,
    "reports/FULL_CATALOG_GF0017_BATCH_READINESS.md": 40,
    "reports/full_catalog_gf0017_source_join_batch.json": 100000,
    "reports/FULL_CATALOG_GF0017_SOURCE_JOIN_BATCH.md": 45,
    "reports/full_catalog_agent_standard_mapping_plan.json": 3000,
    "reports/FULL_CATALOG_AGENT_STANDARD_MAPPING_PLAN.md": 60,
    "reports/full_catalog_agent_mapping_evidence_join_design.json": 700,
    "reports/FULL_CATALOG_AGENT_MAPPING_EVIDENCE_JOIN_DESIGN.md": 60,
    "reports/FULL_CATALOG_AGENT_MAPPING_EVIDENCE_JOIN.md": 50,
    "reports/full_catalog_source_resolution_plan.json": 500,
    "reports/FULL_CATALOG_SOURCE_RESOLUTION_PLAN.md": 70,
    "reports/full_catalog_row_level_extraction_specs.json": 450,
    "reports/FULL_CATALOG_ROW_LEVEL_EXTRACTION_SPECS.md": 70,
    "reports/FULL_CATALOG_ROW_LEVEL_EXTRACTION_RESULTS.md": 50,
    "reports/full_catalog_evidence_review_plan.json": 400,
    "reports/FULL_CATALOG_EVIDENCE_REVIEW_PLAN.md": 50,
    "reports/full_catalog_parser_implementation_plan.json": 500,
    "reports/FULL_CATALOG_PARSER_IMPLEMENTATION_PLAN.md": 50,
    "docs/CNBE32_GF0017_AGENT_TECHNICAL_WHITEPAPER.md": 150,
    "docs/CNBE_HANZI_STRUCTURE_AGENT_MODEL.md": 150,
    "tests/test_full_catalog_tools.py": 120,
    "tests/test_full_catalog_excel_schema_inspection.py": 80,
    "tests/test_v4_fixed_sample_rows.py": 50,
    "tests/test_v4_fixed_unicode_identity.py": 50,
    ...
    "tests/test_cnbe_agent_runtime_logic.py": 40,
    "tests/test_full_catalog_gf0017_preflight_plan.py": 50,
    "tests/test_full_catalog_gf0017_source_mapping.py": 50,
    "tests/test_full_catalog_gf0017_join_schema.py": 50,
    "tests/test_full_catalog_gf0017_blocker_reconciliation.py": 40,
    "tests/test_structured_8105_knowledge_diff_packet.py": 40,
    "tests/test_structured_8105_knowledge_patch.py": 30,
    "tests/test_full_catalog_gf0017_batch_readiness.py": 40,
    "tests/test_full_catalog_gf0017_source_join_batch.py": 40,
    "tests/test_full_catalog_agent_standard_mapping_plan.py": 50,
    "tests/test_full_catalog_agent_mapping_evidence_join_design.py": 55,
    "tests/test_full_catalog_agent_mapping_evidence_join.py": 50,
    "tests/test_full_catalog_source_resolution_plan.py": 60,
    "tests/test_full_catalog_row_level_extraction_specs.py": 50,
    "tests/test_full_catalog_row_level_extraction_results.py": 50,
    "tests/test_full_catalog_evidence_review_plan.py": 50,
    "tests/test_full_catalog_parser_implementation_plan.py": 50,
    "docs/FULL_CATALOG_DATABASE.md": 140,
    "docs/DATA_REPRODUCIBILITY_CONTRACT.md": 60,
    "scripts/plan_8105_runtime_blocker_resolution.py": 300,
    "scripts/apply_8105_standardized_runtime_repair.py": 600,
    "tests/test_8105_runtime_blocker_resolution_plan.py": 35,
    "tests/test_8105_standardized_runtime_repair.py": 45,
    "reports/8105_runtime_blocker_resolution_plan.json": 800,
    "reports/8105_RUNTIME_BLOCKER_RESOLUTION_PLAN.md": 50,
    "review_packets/8105_full/8105_runtime_blocker_resolution_queue.csv": 1300,
    "reports/8105_standardized_runtime_repair.json": 300,
    "reports/8105_STANDARDIZED_RUNTIME_REPAIR.md": 50,
    "review_packets/8105_full/8105_standardized_runtime_repair_applied.csv": 590,
    "review_packets/8105_full/8105_standardized_runtime_repair_remaining_blockers.csv": 790,
    "data/history/legacy-ai-generated/README.md": 35,
    "data/history/legacy-ai-generated/manifest.json": 20,

#!/usr/bin/env bash
# SCNet CNBE-MoE startup for 113 group DCU BW 2 cards.
# Resource: 异构加速卡BW x 2 (panel total 256GB), DTK 26.04.
...
CONFIG="${CNBE_MOE_CONFIG:-scnet_moe_config_dcu2.yaml}"
...
echo "== CNBE-MoE SCNet startup (DCU BW 2 cards) =="
echo "root=$ROOT"
echo "data=$DATA"
echo "out=$OUT"
echo "config=$CONFIG"
